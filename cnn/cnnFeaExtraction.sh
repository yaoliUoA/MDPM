...
#PBS -o cnnFeaExtraction_${PBS_ARRAYID}.log
#PBS -o cnnFeaExtraction_${PBS_ARRAYID}.err
...
matlab -singleCompThread -nojvm -nosplash -nodesktop -r "cnnFeaExtraction(${PBS_ARRAYID}); quit;"